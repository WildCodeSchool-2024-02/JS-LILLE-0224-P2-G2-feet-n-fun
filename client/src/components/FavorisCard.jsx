          ...
          <div className="cardContainerFav">
                  ...
                  <img className="imgSocksFav" src={src} alt="" />
                      ...
                      <div className="cardTextFav">
                          ...
                          <div className="priceFav"><p>{price}€</p></div>
                      </div> 
                      <div className="cardButtonsFav">
                          <button label="Supprimer" type="button"><img alt="Ajouter au Panier" src="./public/assets/images/icons/add-cart.svg"/></button>
                          <button label="Ajout Favoris" type="button"><img alt="supprimer" src="./public/assets/images/icons/trash-bin.svg"/></button>
                      </div>
