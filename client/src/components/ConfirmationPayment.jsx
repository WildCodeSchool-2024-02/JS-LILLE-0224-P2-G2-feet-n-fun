...
function ConfirmationPayment ({clientName, clientSurname, clientMail}) {
    ...
    return (
        <p className="confirmationMessagePayment">Merci pour votre commande <div className="infosClient">{clientName} {clientSurname} ! </div> Un e-mail de confirmation vous a été envoyé à <div className="infosClient">{clientMail}</div>
</p>
    )
}
